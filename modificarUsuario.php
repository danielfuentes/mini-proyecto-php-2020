<?php
    ...
    if($_POST){
        $errores = validarUsuarioModificado($_POST);
        //dd($errores);
        if(empty($errores)){
            $modificar = modificarUsuario($bd,'usuarios',$_POST);
...
<body>
    <div class="container-fluid">
        ...
        <h1 class= "display-4 text-white bg-info text-center pt-5">Modificar Usuario</h1>
