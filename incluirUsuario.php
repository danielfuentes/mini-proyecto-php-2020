...
if($_POST){
    ...
    if(count($errores)==""){
        ...
        //Aquí es opcional sindesean o no enviarle un correo al usuario que el Administrador está registrando
        //enviarCorreo($_POST);
  ...
  <body>
    ...
    <!-- Cuerpo principal -->
        ...
        <article class="col-12">
          <h2 class="display-4 text-white bg-info text-center pt-5">Registro de usuarios</h2>
        </article>
